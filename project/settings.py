...
# Setup environ
env = environ.Env()
environ.Env.read_env(os.path.join(BASE_DIR, ".env"))  # Load .env file first

# Debug & secret key
DEBUG = env.bool("DEBUG", default=True)
SECRET_KEY = env("SECRET_KEY", default="*j-siik09)%oe1y)l3z%qy3!5r5^yrc4)i&9#wm0-&k=0c2)y_#=n")

# Firebase
FIREBASE_CRED_PATH = env("FIREBASE_CRED_PATH", default=r"C:\Users\sesan\Downloads\firebase-key.json")
...
ANALYTICS_TAG_ID = env('GOOGLE_ANALYTICS', default="G-TEST12345") # for analytics tag on frontend
...
PAYMENT_VARIANTS = {
    'stripe': (
        ...
        'payments.stripe.StripeProvider',
        {
            ...
            'secret_key': env('STRIPE_TEST_API_KEY', default='dummy_secret'),
            'public_key': env('STRIPE_PUB_TEST_KEY', default='dummy_public'),
            'endpoint_secret': env('STRIPE_WEBHOOK_TEST_API_KEY', default='dummy_webhook'),
